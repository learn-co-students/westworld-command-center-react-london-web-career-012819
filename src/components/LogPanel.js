...
const LogPanel = (props) => {
  ...
  return(
    <Segment className="HQComps" id="logPanel">
      <pre>
        {props.log.map((log, i) => <p key={i} className={log.type}>{log.msg}</p>)}
      </pre>
      ...
      <Button 
        ...
        fluid
        color={props.activateToggle ? "red" : "green"}
        content={props.activateToggle ? "ACTIVATE ALL" : "DECOMMISSION ALL"}
      /> 
    </Segment>
  )
}
